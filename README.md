...
5. Choose the downloaded `next-clean-restart-1.3.2.vsix` file.
...
```bash
code --install-extension next-clean-restart-1.3.2.vsix
```

> **For Cursor or VSCodium:**
> ```bash
> cursor --install-extension next-clean-restart-1.3.2.vsix
> # or
> codium --install-extension next-clean-restart-1.3.2.vsix
> ```
